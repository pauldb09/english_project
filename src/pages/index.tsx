...
export default function Example() {
    return (
        <div className="isolate bg-black">
            ...
            <div className="px-6 pt-6 lg:px-8 text-white">
                ...
                <div className="relative px-6 lg:px-8 text-white">
                    <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
                        <div className="hidden sm:mb-8 sm:flex sm:justify-center">
                            <div className="relative rounded-full py-1 px-3 text-sm leading-6 text-white-600 ring-1 ring-white-900/10 hover:ring-white-900/20">
                        ...
                        <div className="text-center">
                            <h1 className="text-4xl font-bold text-white tracking-tight text-white-900 sm:text-6xl">Data to enrich your online business</h1>
                            ...
                            <div className="mt-10 flex items-center justify-center gap-x-6">
                                ...
                                <a href="#" className="text-base font-semibold leading-7 text-white-900">
